...
namespace lagrello.Model
{
    ...
    public partial class CreateUserRequest :  IEquatable<CreateUserRequest>, IValidatableObject
    {
        ...
        public CreateUserRequest(string email = default(string), string userId = default(string))
        {
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new InvalidDataException("userId is a required property for CreateUserRequest and cannot be null");
            }
            else
            {
                this.UserId = userId;
