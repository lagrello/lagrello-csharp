...
${nuget_cmd} install src/lagrello/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/lagrello.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/lagrello.dll \
-recurse:'src/lagrello/*.cs' \
-doc:bin/lagrello.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/lagrello.dll was created successfully"
fi
